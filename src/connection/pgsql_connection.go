...
func DefaultConnectionInfo(al *args.ArgumentList) Info {
	log.Info("Default ConnectionCreating connection info from args: Database=%s, Username=%s, Password=%s, Host=%s, Port=%s, Timeout=%s, EnableSSL=%t, SSLCertLocation=%s, SSLRootCertLocation=%s, SSLKeyLocation=%s, TrustServerCertificate=%t",
