...
func TestPopulateIndividualQueryMetrics(t *testing.T) {
	...
	individualQueryMetrics := performancemetrics.PopulateIndividualQueryMetrics(conn, slowRunningQueries, pgIntegration, gv, nil)
...
func TestGetIndividualQueryMetrics(t *testing.T) {
	...
	individualQueryMetricsInterface, individualQueryMetrics := performancemetrics.GetIndividualQueryMetrics(conn, slowRunningQueries, gv, nil)
