...
type WaitEventQuery struct {
	...
	WaitingTasksCount   *float64 `db:"waiting_tasks_count"   metric_name:"waitevent.waiting_tasks_count"        source_type:"gauge"`
	CollectionTimestamp *string  `db:"collection_timestamp"  metric_name:"waitevent.collection_timestamp"       source_type:"attribute"`
	QueryID             *float64 `db:"query_id"              metric_name:"waitevent.query_id"                   source_type:"gauge"`
