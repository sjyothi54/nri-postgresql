...
type WaitEventQuery struct {
	...
	QueryID             *int64   `db:"query_id"              metric_name:"waitevent.query_id"                   source_type:"attribute"`
	QueryText           *string  `db:"query_text"            metric_name:"waitevent.query_text"                 source_type:"gauge"`
