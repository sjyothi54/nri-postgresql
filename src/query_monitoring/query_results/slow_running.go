...
func PopulateSlowRunningMetrics(instanceEntity *integration.Entity, conn *connection.PGSQLConnection) {
	...
	if isExtensionEnabled {
		...
		for _, model := range slowQueries {
			metricSet := instanceEntity.NewMetricSet("PostgresqlBlockingQuerySample")
...
func PopulateBlockingQueriesMetrics(entity *integration.Entity, conn *connection.PGSQLConnection) {
	...
	//}
	mmm := entity.NewMetricSet("testBlockQueries")
